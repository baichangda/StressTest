...
//    byte status;
    ...
    public static void main(String[] args) {
        String hex="";
        Parser_ICKey parser=new Parser_ICKey();
        PacketData packetData= parser.parse(PacketData.class, Unpooled.wrappedBuffer(ByteBufUtil.decodeHexDump(hex)));
        VehicleData vehicleData=parser.parse(VehicleData.class,Unpooled.wrappedBuffer(packetData.getContent()));
    }
